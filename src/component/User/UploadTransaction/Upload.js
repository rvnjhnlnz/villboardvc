...
function Upload() {
    ...
    const validate = () => {
        let isValid = true;
        let fnError, lnError, adError, pnError, ppError = "";
        ...
        if (!ut_address) {
            ...
            var pattern2 = new RegExp(/^[A-Za-z0-9,. _]*[A-Za-z0-9,.][A-Za-z0-9,. _]*$/);
            if (!pattern2.test(ut_address)) {
        ...
        if (!ut_phoneNumber) {
            ...
            var pattern3 = new RegExp(/^(09|\+639)\d{9}$/);
            if (!pattern3.test(ut_phoneNumber)) {
        ...
        if (fnError || lnError || adError || pnError || ppError) {
    ...
    function handleSubmit(event) {
        ...
        fd.append('userId', decodedToken._id);
        fd.append('uPhoneNumber', ut_phoneNumber);
        fd.append('refNumber', refNum);
        ...
        <div class="ut_container">
            <div className="ut_wrapper">
                <form className="v_form">
                    ...
                    <div className="upload_input-field">
                        <input type="file" accept="image/*" className="form-control1" onChange={(e) => handleFile(e)} />
                        <div style={{ fontSize: 12, color: "red" }}>
